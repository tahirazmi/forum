    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/2000x400/?coding,java" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2000x400/?code,php" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2000x400/?andriod,code" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <?php
                         ...
                         while($row = mysqli_fetch_assoc($result)){
                            ...
                            $id = $row['category_id'];
                             ...
                             echo '<div class="col-md-4 my-4 my-2">
